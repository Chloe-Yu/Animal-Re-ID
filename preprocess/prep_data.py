...
def prep_elephant(train_save_path,val_save_path):
    ...
    download_path = "../data/elephant/"
    train_path = download_path
    if not os.path.isdir("../data/Animal"):
        os.makedir("../data/Animal")
...
def prep_tiger(train_save_path,val_save_path):
    train_imgs = pd.read_csv('../data/tiger/atrw_anno_reid_train/reid_list_train.csv',header=None)
    ...
    train_path = "../data/tiger/atrw_re_id_train/train/"
...
def prep_all():
    ...
    train_save_path = "../data/Animal/train"
    val_save_path = "../data/Animal/val"
